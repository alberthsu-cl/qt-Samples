...
inline const std::array<MediaAsset, 6> &demoAssets()
{
    static const std::array<MediaAsset, 6> assets = {{
        { L"Mountainbike.mp4", L"Video", L"00:00:10", 300,  RGB(174, 116, 45) },
        { L"Food.jpg",          L"Image", L"Still",    90,   RGB(179, 77, 44) },
        { L"Forest.jpg",        L"Image", L"Still",    90,   RGB(47, 112, 65) },
        { L"Mahoroba.mp3",      L"Audio", L"00:02:19", 4170, RGB(40, 120, 180) },
        { L"Skateboard.mp4",    L"Video", L"00:00:10", 300,  RGB(77, 145, 184) },
        { L"Sport.jpg",         L"Image", L"Still",    90,   RGB(126, 94, 72) },
    }};
